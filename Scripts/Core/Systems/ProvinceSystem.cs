...
namespace Core.Systems
{
    ...
    public class ProvinceSystem : MonoBehaviour, System.IDisposable
    {
        ...
        public ushort GetProvinceController(ushort provinceId) => dataManager.GetProvinceController(provinceId);
        ...
        public void FillOwnerBuffer(uint[] ownerBuffer) => dataManager.FillOwnerBuffer(ownerBuffer);
