...
namespace Map.Rendering
{
    ...
    public class VisualTextureSet
    {
        ...
        private RenderTexture detailIndexTexture;     // RGBA8: 4 material indices per pixel
        private RenderTexture detailMaskTexture;      // RGBA8: 4 blend weights per pixel
        ...
        private static readonly int DetailIndexTextureID = Shader.PropertyToID("_DetailIndexTexture");
        private static readonly int DetailMaskTextureID = Shader.PropertyToID("_DetailMaskTexture");
        ...
        public RenderTexture DetailIndexTexture => detailIndexTexture;
        public RenderTexture DetailMaskTexture => detailMaskTexture;
        ...
        /// <summary>
        /// Set terrain blend map textures (created by TerrainBlendMapGenerator)
        /// Imperator Rome-style 4-channel material blending system
        /// </summary>
        ...
        public void BindToMaterial(Material material)
        {
            ...
            // Bind terrain blend maps if available (Imperator Rome-style blending)
            if (detailIndexTexture != null)
            {
                material.SetTexture(DetailIndexTextureID, detailIndexTexture);
            }

            if (detailMaskTexture != null)
            {
                material.SetTexture(DetailMaskTextureID, detailMaskTexture);
            }
        ...
        public void Release()
        {
            ...
            // Release terrain blend maps
            if (detailIndexTexture != null) detailIndexTexture.Release();
            if (detailMaskTexture != null) detailMaskTexture.Release();
        }
    }
}
