...
namespace Map.Province
{
    ...
    public static class GPUProvinceNeighborDetector
    {
        ...
        static GPUProvinceNeighborDetector()
        {
            ...
            {
                Debug.LogError($"Failed to load compute shader at {COMPUTE_SHADER_PATH}");
            }
        }
            ...
            int provinceCount)
        {
            ...
            Debug.Log($"[GPU] Detecting neighbors for {provinceCount} provinces on {width}x{height} texture");
            ...
            try
            {
                ...
                Debug.Log($"[GPU] Found {actualPairCount} neighbor pairs and {actualCoastalCount} coastal provinces");
                ...
                Debug.Log($"[GPU] Neighbor detection complete in ~{Time.deltaTime * 1000:F2}ms");
            }
            finally
            {
